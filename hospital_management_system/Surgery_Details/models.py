...
class Surgery(models.Model):
	...
	# doctor_incharge = models.ForeignKey(Doctor, null=True, related_name = 'surgery', on_delete=models.CASCADE)
	# nurse_incharge = models.ForeignKey(Nurse, null=True, related_name = 'surgery', on_delete=models.CASCADE)
